function G(n, e) {
    ...
    // console.log(e)
    // u({
    //     url: "".concat('https://user.hrdjyun.com/wechat/phonePwdLogin'),
    //     method: "post",
    //     headers: {
...
// e_res = G('wechat/phonePwdLogin', req_d)  //{phoneNum: '13216077035', pwd: 'f6ba3bc8fb16582e89a596b8de4bf466', t: 1715820018954, tenant: 1}
// console.log(e_res)
function get_token(){
    return G('wechat/phonePwdLogin', req_d)
}